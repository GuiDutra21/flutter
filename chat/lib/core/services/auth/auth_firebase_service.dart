...
class AuthFirebaseService implements AuthService {
  ...
  Future<void> signup(
    ...
    UserCredential credential = await auth.createUserWithEmailAndPassword(
      email: email,
      password: password,
    ); // Cria o usuario no firebase e retorna as credenciais do usuario
  ...
  Future<String?> _uploadUserImage(File? image, String imageName) async {
    ...
    // imageRef representa a referencia de onde a imagem esta
    final imageRef = storage
        .ref()
        .child('user_images')
        .child(
          imageName,
        ); // Sera salvo na pasta 'user_images' e com o nome de imageName
  ...
  // Apenas para convertar o usuario do firebase em usuario da aplicacao (do models)
