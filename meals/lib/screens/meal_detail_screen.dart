...
class MealDetailScreen extends StatelessWidget {
  ...
  Widget _createContainer(
      {required Widget child, required double containerHeight}) {
    return Container(
      ...
      body: SingleChildScrollView(
        child: Column(children: <Widget>[
          ...
          Padding(
            ...
            child: MediaQuery.of(context).orientation == Orientation.portrait // Dependendo da orientação da tela muda a altura da imagem
                ? ClipRRect(
